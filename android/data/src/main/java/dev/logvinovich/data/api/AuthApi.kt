...
import dev.logvinovich.data.model.TokenRequest
import dev.logvinovich.data.model.UserAuthRequest
...
suspend inline fun HttpClient.register(username: String, password: String, role: Role): Result<AuthTokenDto> {
    return apiRequest {
        post("/user/register") {
